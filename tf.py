...
# print (tf.random.normal((2,3), 0, 1))

# # tf.add (a,b ) сложение тенхоров 
# tf.tensordot(a,b, axes = 0) умножая векторы получим матрицу если аксес 1 получи число   
# matmul(a,b) умножение матриц
...
Blog
About
tensorflow/tf_7_2.py at main · selfedu-rus/tensorflow